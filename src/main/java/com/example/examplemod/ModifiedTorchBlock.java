...
public class ModifiedTorchBlock extends Block {
   protected static final int AABB_STANDING_OFFSET = 2;
   protected static final VoxelShape AABB = Block.box(6.0D, 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);
   protected final ParticleOptions flameParticle;
    protected int remainingTicks = 100;

   public ModifiedTorchBlock(BlockBehaviour.Properties p_57491_) {
      super(p_57491_);
      this.flameParticle = new DustParticleOptions (new Vector3f (), 0);
   }
   ...
   public void animateTick(BlockState p_222593_, Level p_222594_, BlockPos p_222595_, RandomSource p_222596_) {
      ...
      if (remainingTicks-- <= 0) destroy (null, null, null);
   }
}
